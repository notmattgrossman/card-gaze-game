/* autogenerated by Processing revision 1293 on 2025-11-18 */
...
public boolean isMouseOverCard(float mx, float my, float x, float y) {
...
public boolean isCurrentlyFlipped(int row, int col) {
...
public FlippingCard getFlippingCard(int row, int col) {
...
public void removeFromFlipped(int row, int col) {
...
public void initializeCardAssignments() {
...
public float bezierEase(float t) {
  if (t < 0.5f) {
    return 4 * t * t * t;
  } else {
    float u = -2 * t + 2;
...
public void createConfetti(float x, float y) {
...
pixelDensity(2); }
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "cards" };
    if (passedArgs != null) {
